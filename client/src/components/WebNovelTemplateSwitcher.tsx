      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <div className="flex items-center gap-2 text-sm font-medium text-[var(--text-primary)]">
            ...
            网文模板
            {chapterTemplateId && (
              <span className="rounded bg-[var(--accent-color)]/10 px-2 py-0.5 text-xs text-[var(--accent-color)]">章节覆盖</span>
            )}
          </div>
        ...
        <div className="flex shrink-0 items-center gap-1 rounded bg-[var(--bg-tertiary)] px-2 py-1 text-xs text-[var(--text-secondary)]">
